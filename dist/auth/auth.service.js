...
let AuthService = class AuthService {
    ...
    async register(username, passwordPlain, role, restaurantId) {
    ...
    async login(username, passwordPlain) {
        ...
        const access_token = this.jwtService.sign(payload, { expiresIn: accessExpiry });
        const refresh_token = this.jwtService.sign({ sub: user._id.toString() }, { expiresIn: refreshExpiry });
